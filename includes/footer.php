	...
	<nav>
		<ul id="mobile-toolbar">
			...
			<li>
				<a href="#" onclick="document.getElementById('search-field').focus();return false;" class="svg toolbar-search"><span class="visually-hidden">Vai al modulo per cercare tra gli articoli</span></a>
			</li>
			<li>
