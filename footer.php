	<footer aria-label="Collegamenti utili">		
			<div>
				...
				In quest'angolino sperduto della rete condivido quello che mi passa per la testa: un laboratorio creativo aperto al confronto di opinioni.</p>
			</div>
			...
			<nav>
				...
				<ul>
					...
					<li><a href="https://github.com/gerlandotermini/duechiacchiere.it-themes-duechiacchiere" title="parte del software che sviluppo e rendo disponibile al pubblico">Il vestito digitale su <span lang="en">Github</span></a></li>
					...
					<li><a href="https://validator.w3.org/nu/?doc=https%3A%2F%2Fwww.duechiacchiere.it%2F" title="pagina in inglese per verificare la correttezza semantica di un sito">Un codice impeccabile</a></li>
				</ul>
			</nav>
			...
			<nav>
				...
				<ul>
					<li><a href="https://www.linkedin.com/in/gerlando/">Il mio profilo su LinkedIn</a></li>
					...
					<li><a href="/diretta" title="un programmino scatta una foto di quello che vedo dalla finestra del mio ufficio">In diretta dalla casa</a></li>
				</ul>
			</nav>
