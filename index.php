	...
	<main id="content"><?php
		...
		while ( have_posts() ):
			...
			switch( $comment_count ) {
				case 0:
					$comments_html = '<a class="comments-link" href="' . ( !is_single() ? get_permalink() : '' ) . '#comment" aria-label="Esprimi la tua opinione su '. $GLOBALS[ 'post' ]->post_title . '">Lascia un commento</a>';
					break;
				case 1:
					$comments_html = '<a class="comments-link" href="' . ( !is_single() ? get_permalink() : '' ) . '#comments" aria-label="Leggi il commento per '. $GLOBALS[ 'post' ]->post_title . '">1 commento</a><span class="visually-hidden"> &mdash; </span><a class="skip-inline" href="' . ( !is_single() ? get_permalink() : '' ) . '#comment" aria-label="Esprimi la tua opinione su '. $GLOBALS[ 'post' ]->post_title . '">Lascia un commento</a>';
					break;
				default:
					$comments_html = '<a class="comments-link" href="' . ( !is_single() ? get_permalink() : '' ) . '#comments" aria-label="Leggi i ' . $comment_count . ' commenti per ' . $GLOBALS[ 'post' ]->post_title . '">' . $comment_count . ' commenti</a><span class="visually-hidden"> &mdash; </span><a class="skip-inline" href="' . ( !is_single() ? get_permalink() : '' ) . '#comment" aria-label="Esprimi la tua opinione su '. $GLOBALS[ 'post' ]->post_title . '">Lascia un commento</a>';
			}
			?>
