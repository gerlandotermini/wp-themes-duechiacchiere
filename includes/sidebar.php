<aside>
	<div class="widget" id="search-form-widget">
		...
		<form role="search" action="<?= esc_url( home_url( '/' ) ); ?>" method="get" id="search-form">
			...
			<input type="search" id="search-field" role="combobox" aria-controls="live-results" aria-expanded="false" aria-autocomplete="list" autocomplete="off" name="s" required="" placeholder="Cerca nell'archivio..." aria-owns="live-results">
			<button type='submit' id="search-button" class="svg" aria-label="Avvia la ricerca">Cerca</button>
		</form>
