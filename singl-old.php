...
<div id="content-wrapper">
	<main id="content">
		<article>
			<header>
				<h1><?php the_title( '', '' ) ?></h1>
				<h2 class="visually-hidden">Informazioni su questo articolo:</h2>
				<ul class="post-information">
					<li><span class="visually-hidden">Scritto il giorno </span><time datetime="<?= the_time( 'Y-m-d H:i:s' ) ?>"><?= the_time('j F Y'); ?></time></li>
					<?php
						if ( !empty( $categories_html ) ) {
							echo '<li><span class="visually-hidden">Archiviato in </span>' . $categories_html . '</li>';
						}
					?>
					<a href="#comments">6 comments</a></li>
					<li>
			</header>
			<?php the_content(); ?>
